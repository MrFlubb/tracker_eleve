...
export const CurrencyEuroIcon: React.FC = () => (
...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className = "animate-spin -ml-1 mr-3 h-5 w-5" }) => (
...
export const RefreshIcon: React.FC<RefreshIconProps> = ({ spinning }) => (
  <svg 
  ...
  >
    <path 
      ...
      d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-4.991-2.695v4.992h-4.992" 
    />
  </svg>
);
